...
export default function Footer() {
  return (
    <footer className="bg-olive text-beige py-20 px-6 border-t border-white/5">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
          ...
          <div>
            ...
            <p className="font-sans text-beige/40 text-sm tracking-widest leading-relaxed font-light">
          ...
          {/* Contact Column */}
          <div>
            <h4 className="font-serif text-lg uppercase tracking-widest mb-8">Phone Support</h4>
          ...
          {/* Address Column */}
          <div>
            <h4 className="font-serif text-lg uppercase tracking-widest mb-8">Location</h4>
          ...
          {/* Social Column */}
          <div>
            <h4 className="font-serif text-lg uppercase tracking-widest mb-8">Connect With Us</h4>
