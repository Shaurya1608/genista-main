...
const rooms = [
  {
    ...
    img: "/landing/hotel-imagges/landing-hotel.png"
  },
  {
    title: "Onyx Lounge",
    desc: "Deep textures and ambient lighting for the ultimate retreat.",
    img: "/landing/hotel-imagges/landing-hotel-2.png"
  },
  {
  ...
  return (
    <div ref={containerRef} className="overflow-hidden bg-black">
      <div ref={scrollRef} className="flex h-screen w-max items-center px-[10vw]">
        ...
        {/* Intro Slide */}
        <div className="w-[80vw] md:w-[40vw] flex flex-col justify-center pr-24">
          <h2 className="font-serif text-5xl md:text-7xl lg:text-8xl tracking-widest uppercase mb-8">Rooms <br/>& Suites</h2>
          <p className="font-sans text-white/40 tracking-[0.3em] uppercase text-xs md:text-sm">
        ...
        {/* Room Slides */}
        {rooms.map((room, i) => (
          <div key={i} className="w-[80vw] md:w-[60vw] lg:w-[45vw] h-[70vh] flex flex-col px-8 relative group">
            ...
            <div className="pt-8">
              <span className="text-gold font-script text-2xl mb-2 block">0{i + 1}</span>
              <h3 className="font-serif text-3xl md:text-4xl tracking-widest uppercase mb-4">{room.title}</h3>
              <p className="font-sans text-white/40 text-sm tracking-widest leading-relaxed max-w-sm">
                {room.desc}
              </p>
            </div>
          </div>
        ...
        <div className="w-[60vw] flex flex-col items-center justify-center">
            <button className="border border-white/20 px-12 py-5 text-[11px] uppercase tracking-[0.5em] hover:bg-white hover:text-black transition-all duration-700">
                View All Rooms
            </button>
        </div>
